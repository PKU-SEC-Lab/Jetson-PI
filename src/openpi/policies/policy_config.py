...
def create_trained_policy(
    ...
    *,
    ...
    model: _model.BaseModel | Any | None = None,
) -> _policy.Policy:
    ...
    Args:
        ...
        model: If provided, skip loading weights from disk and use this model instance directly.
    ...
    if model is None:
        ...
        # Infer pytorch flag from provided model type if caller preloaded it.
        try:
            import torch
