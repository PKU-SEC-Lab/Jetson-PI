...
Example:
    # pi0_droid
    python examples/convert_jax_model_to_pytorch.py --checkpoint_dir PATH/TO/CHECKPOINT/pi0_droid --output_path PATH/TO/CHECKPOINT/pi0_droid_pytorch

    # pi0_aloha_sim
    python examples/convert_jax_model_to_pytorch.py --checkpoint_dir PATH/TO/CHECKPOINT/pi0_aloha_sim --output_path PATH/TO/CHECKPOINT/pi0_aloha_sim_pytorch

    # pi05_droid
    python examples/convert_jax_model_to_pytorch.py --checkpoint_dir PATH/TO/CHECKPOINT/pi05_droid --output_path PATH/TO/CHECKPOINT/pi05_droid_pytorch
"""
